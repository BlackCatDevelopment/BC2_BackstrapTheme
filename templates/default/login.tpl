...
<body class="login-screen-bg">
    <div class="container">
        <div class="row vertical-center-row">
            <div class="col-md-6 offset-md-3 col-center-block login-widget">
                <div class="card w-100">
                    <div class="card-header text-center">
                        <h3><span class="fa fa-lock"></span> {translate('Login')}</h2>
                    </div>
                    <div class="card-body">
                        <div class="card-text">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <a href="#" class="card-link"><i class="fa fa-fw fa-question-circle"></i> Todo: Kennwort vergessen</a>
                            </div>
                            <div class="col-6 text-right">
                                <a href="{$CAT_SITE_URL}" class="card-link"><i class="fa fa-fw fa-home"></i> {translate('Homepage')}</a>
                            </div>
                        </div>
                    </div>
                </div>
