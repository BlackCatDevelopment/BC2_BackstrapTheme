...
if(\CAT\Backend::getArea()!=='login') {
    $mod_footers = array(
        'backend' => array(
            'js' => array(
                // required popper.js is included in bootstrap bundle
                'CAT/vendor/twbs/bootstrap/dist/js/bootstrap.bundle.min.js',
                // tippy also requires popper, so load it after bootstrap bundle
                'modules/lib_javascript/plugins/tippy/1.4.1/tippy.js',
